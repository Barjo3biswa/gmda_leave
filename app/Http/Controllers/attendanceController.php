...
class attendanceController extends Controller
{
    ...
    public function attendanceIndex(Request $request)
    {
        ...
        // dd($holiday);
        $employees = User::with([
            'attendance' => function ($query) use ($current_month, $current_year) {
        ...
        if ($request->type == 'user' || $request->expectsJson()) {
            ...
            return view('attendance.view-attendance', compact(
                'employees',
                'holiday',
                'type',
                'current_month',
        ...
        } else if (commonHelper::isPermissionExist('attendance_management')) {
