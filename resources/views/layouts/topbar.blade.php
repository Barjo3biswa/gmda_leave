    ...
    <div class="header-top-menu tabl-d-n">
        <ul class="nav navbar-nav mai-top-nav">
            ...
            <li class="nav-item dropdown res-dis-nn">
                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">Attendance <span class="angle-down-topmenu"><i class="fa fa-angle-down"></i></span></a>
                <div role="menu" class="dropdown-menu animated zoomIn">
                    <a href="{{route('leave.attendance-view',['type'=>'user'])}}" class="dropdown-item">View</a>

                    @if (\App\Helpers\commonHelper::isPermissionExist('attendance_view_manage'))
            ...
            <li class="nav-item dropdown res-dis-nn">
                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">Shift Management <span class="angle-down-topmenu"><i class="fa fa-angle-down"></i></span></a>
                <div role="menu" class="dropdown-menu animated zoomIn">
            ...
            <li class="nav-item dropdown res-dis-nn">
                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">Leave<span class="angle-down-topmenu"><i class="fa fa-angle-down"></i></span></a>
                <div role="menu" class="dropdown-menu animated zoomIn">
                    ...
                    @if (\App\Helpers\commonHelper::isPermissionExist('approve_leave') || \App\Helpers\commonHelper::isPermissionExist('recommand_leave'))
                        ...
                        <a href="{{route('leave.leave-inbox',['type'=>'outbox'])}}" class="dropdown-item">Outbox</a>
                    @endif
                </div>
            </li>
