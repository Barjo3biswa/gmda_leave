                                ...
                                <div class="analytics-content">
                                    ...
                                    <div class="progress m-b-0">
                                        <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="50"
                                            aria-valuemin="0" aria-valuemax="100" style="width:{{ $present_percentage }}%;">
                                            <span class="sr-only">{{ $present_percentage }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="analytics-content">
                                    ...
                                    <div class="progress m-b-0">
                                        <div class="progress-bar progress-bar-inverse" role="progressbar" aria-valuenow="50"
                                            aria-valuemin="0" aria-valuemax="100" style="width:{{ $absent_percentage }}%;">
                                            <span class="sr-only">{{ $absent_percentage }}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="analytics-content">
                                    ...
                                    <div class="progress m-b-0">
                                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="50"
                                            aria-valuemin="0" aria-valuemax="100" style="width:{{ $late_percentage }}%;">
                                            <span class="sr-only">{{ $late_percentage }}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="analytics-content">
                                    ...
                                    <div class="progress m-b-0">
                                        <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="50"
                                            aria-valuemin="0" aria-valuemax="100" style="width:{{ $leave_percentage }}%;">
                                            <span class="sr-only">{{ $leave_percentage }}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-sales-chart">
                        ...
                        <div class="row" style="justify-content: center;display: flex;">
                            <button class="btn btn-primary btn-xs" onclick="loadGraph(7)">One Week</button> &nbsp;
                            <button class="btn btn-primary btn-xs" onclick="loadGraph(30)">One Month</button> &nbsp;
                            <button class="btn btn-primary btn-xs" onclick="loadGraph(365)">One Year</button> &nbsp;
