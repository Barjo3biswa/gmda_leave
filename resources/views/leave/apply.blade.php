    ...
    <style>
        ...
        @media (min-width:768px) {
            ...
            .timeline-steps .timeline-step.applied:not(:first-child):before {
                border-top: .25rem solid rgb(120, 161, 120);
                /* Green dotted line */
            }
        }
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="review-content-section">
                                            <form action="{{ route('leave.apply-save') }}" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="employee_id" id="employee_id" class="form-control"
                                                                onchange="this.value='{{ Auth::user()->id }}'" required>
                                                                <option value="">--Select--</option>
                                                                @foreach ($users as $user)
                                                                    <option value="{{ $user->id }}"
                                                                        {{ Auth::user()->id == $user->id ? 'selected' : '' }}>
                                                                        {{ $user->name }}({{ $user->emp_code }})</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                        <div class="form-group">
                                                            <label for="name">Leave Type
                                                                {{ Request()->get('leave_type') }}<span
                                                                    style="color: red;">*</span></label>
                                                            <select name="leave_type" id="leave_type" class="form-control"
                                                                ...
                                                                @foreach ($leave_type as $type)
                                                                    <option value="{{ $type->id }}"
                                                                        {{ Request()->old('leave_type') == $type->id ? 'selected' : '' }}>
                                                                        {{ $type->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                        <div class="form-group">
                                                            <label for="name">From Date <span
                                                                    style="color: red;">*</span></label>
                                                            <input type="date" name="form_date" id="form_date"
                                                                class="form-control" onchange="getDate()"
                                                                value="{{ Request()->old('form_date') }}" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                        <div class="form-group">
                                                            <label for="name">To Date <span
                                                                    style="color: red;">*</span></label>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="checkbox" id="is_half_day" name="is_half_day"
                                                                value="yes">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="half_day_type" id="half_day_type"
                                                                ...
                                                                <div class="timeline-step applied">
                                                                    <div class="timeline-content" data-toggle="popover"
                                                                        ...
                                                                        <p class="h6 mt-3 mb-1">
                                                                            {{ date('d-m-Y', strtotime($app_trans->date)) }}
                                                                            <br> {{ $app_trans->status }}
                                                                            @if ($app_trans->status == 'Applied')
                                                                                for
                                                                                {{ $my_last_application->LeaveType->name }}
                                                                                ({{ date('d-m-Y', strtotime($my_last_application->from_date)) }}
                                                                                to
                                                                ...
                                                                @if ($app_trans->status != 'Approved' && count($my_last_application->leaveApplicationTrans) == ++$key)
                                                                    <div class="timeline-step ">
                                                                        <div class="timeline-content"
                                                                            ...
                                                                            <div class="inner-circle"></div>
                                                                            <p class="h6 mt-3 mb-1">Waiting for approvel at
                                                                                {{ $app_trans->ToUser->name }}</p>
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                            @endforeach
                                            ...
                                            <div class="sparkline8-hd">
                                                <div class="main-sparkline8-hd">
                                                    <h6>Available Leave- <span
                                                            id="leave_showing">{{ Auth::user()->name }}({{ Auth::user()->emp_code }})</span>
                                                    </h6>
                                                </div>
                                            </div>
                                                        ...
                                                        <tbody id="emp_availability">
                                                            @foreach ($leave_availability as $availability)
                                                                <tr>
                                                                    ...
                                                                    <th><a
                                                                            href="{{ route('leave.trans', ['leave_id' => $availability->leave_type_id, 'emp_id' => Auth::user()->id]) }}">Trans</a>
                                                                    </th>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="review-content-section">
                                            <div class="sparkline8-list">
                                                <div class="sparkline8-hd">
                                                    <div class="main-sparkline8-hd">
                                                        <h6>Other Employee Applications</h6>
                                                    </div>
                                                </div>
                                                <div class="sparkline8-graph">
                                                    <div class="static-table-list">
                                                                ...
                                                                @foreach ($othher_employee_applications as $key => $app)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ date('d-m-Y', strtotime($app->from_date)) }}
                                                                            to
                                                                            {{ date('d-m-Y', strtotime($app->to_date)) }}
                                                                        </td>
                                                                        <td><span
            ...
            $.ajax({
                ...
                'success': function(response) {
                    ...
                    response.leave_availability.forEach(function(availability) {
                        const leaveTypeName = availability.leave_type ? availability.leave_type
                            .name : 'N/A';
                        var transUrl =
                            `{{ route('leave.trans', ['leave_id' => '__leave_id__', 'emp_id' => '__emp_id__']) }}`
