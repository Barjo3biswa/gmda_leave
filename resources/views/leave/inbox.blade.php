                                                        ...
                                                        <tbody>
                                                            @foreach ($applications as $key=>$app)
                                                                <tr>
                                                                    ...
                                                                    <td>@if($app->half_day_on){{date('d-m-Y', strtotime($app->half_day_on))}}@endif</td>
                                                                    ...
                                                                    @if ($type=='inbox')
                                                                        <td><a href="{{route('leave.leave-update',Crypt::encrypt($app->id))}}">Update Application Status</a></td>
                                                                    @endif
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
