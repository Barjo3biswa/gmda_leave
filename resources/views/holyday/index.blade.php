                        ...
                        <div id="myTabContent" class="tab-content custom-product-edit">
                            ...
                            <div class="product-tab-list tab-pane fade active in" id="description">
                                <div class="row">
                                    @if (\App\Helpers\commonHelper::isPermissionExist('holiday_create'))
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="review-content-section">
                                                <form action="{{ route('leave.holyday-import') }}" method="post"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="form-group">
                                                                <a href="{{ route('leave.sample-holyday') }}">Click here for
                                                                    csv sample </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="review-content-section">
                                                <form action="{{ route('leave.holyday-save') }}" method="post"
                                                    class="dropzone dropzone-custom needsclick add-professors"
                                                    id="demo1-upload">
                                                    @csrf
                                                    @if (isset($editable))
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="date" type="date" class="form-control"
                                                                    @if (isset($editable)) value="{{ $editable->date }}" @endif
                                                                    required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="type" id="type" class="form-control"
                                                                    ...
                                                                    <option value="full"
                                                                        @if (isset($editable)) {{ $editable->type == 'full' ? 'selected' : '' }} @endif>
                                                                        Full Day</option>
                                                                    <option value="half"
                                                                        @if (isset($editable)) {{ $editable->type == 'half' ? 'selected' : '' }} @endif>
                                                                        Half Day</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                    ...
                                    @endif
                                    @php
                                        $span = \App\Helpers\commonHelper::isPermissionExist('holiday_create')
                                            ? '6'
                                            : 12;
                                    @endphp
                                    <div
                                        class="col-lg-{{ $span }} col-md-{{ $span }} col-sm-{{ $span }} col-xs-12">
                                                            ...
                                                            @foreach ($holyday_list as $key => $day)
                                                                <tr>
                                                                    ...
                                                                    @if (\App\Helpers\commonHelper::isPermissionExist('holiday_create'))
                                                                        <td>
                                                                            <a
                                                                                href="{{ route('leave.holyday-index', ['id' => Crypt::encrypt($day->id)]) }}"><i
