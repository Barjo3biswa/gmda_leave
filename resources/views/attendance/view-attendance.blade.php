...
.not_in_time {
    background-color: rgb(185, 202, 90);
    color: rgb(168, 21, 21);
    padding: 2px 2px;
    border-radius: 3px;
    font-size: 11px;
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="legend">
                                                    ...
                                                    <span class="half_day circle">hd</span> <span class="half_day circle">P</span>Half Day <br>
                                                            ...
                                                            <tr>
                                                                ...
                                                                @for ($day = 1; $day <= $daysInMonth; $day++)
                                                                    @php
                                                                        ...
                                                                        if($emp->roster){
                                                                            $roster = \App\Models\attendanceRoaster::where('id', $emp->roster)->first();
                                                                            $date_new = new DateTime($date);
                                                                            $dayName = strtolower($date_new->format('l'));
                                                                            $shift = \App\Models\attendanceShift::where('id',$roster->$dayName)->first();
                                                                            ...
                                                                            $weekArray = \App\Helpers\commonHelper::weekArray($emp->shift_id);
                                                                            $weekOfMonth = ceil($day / 7);
                                                                            if ( $dayOfWeek == 6 && (in_array($weekOfMonth,$weekArray))){
                                                                                $isSaturdayOff = true;
                                                                            }
                                                                            $isSunday = ($dayOfWeek == 0);
                                                                            $isHoliday = in_array($date,$holiday);
                                                                    ...
                                                                    @endphp
                                                                        @if ($attendance)
                                                                            ...
                                                                            <td class="{{$attendance->status}} attendance-cell">
                                                                                <div class="tooltip-container">
                                                                                    <span class="on_leave">{{$attendance->attendance}}</span>
                                                                                    <div class="tooltip">
                                                                            ...
                                                                            <td class="{{$attendance->status}} attendance-cell">
                                                                                <div class="tooltip-container">
                                                                                    <span class="{{$attendance->status}}">{{$attendance->attendance}}</span>
                                                                                    <div class="tooltip">
                                                                                        <strong>IN:</strong> {{$attendance->in_time??"NA"}} <br>
                                                                                        <strong>OUT:</strong> {{$attendance->out_time??"NA"}} <br>
                                                                                        <strong>Tot Working Hr:</strong> {{$attendance->working_hour??"NA"}}<br>
                                                                            ...
                                                                            <td class="{{$attendance->status}} attendance-cell">
                                                                                <div class="tooltip-container">
                                                                                    ...
                                                                                    <div class="tooltip">
                                                                                        ...
                                                                                        <strong>Tot Working Hr:</strong> {{$attendance->working_hour}}<br>
                                                                                        <strong>Remarks:</strong> {{$attendance->remarks}}<br>
                                                                                ...
                                                                                <div class="tooltip-container"> --}}
                                                                                    ...
                                                                                    <td class="one_punch attendance-cell">
                                                                                        ...
                                                                                        <div class="tooltip">
                                                                                            ...
                                                                                            <strong>Tot Working Hr:</strong> Not Available<br>
                                                                                            @if (\App\Helpers\commonHelper::isPermissionExist('attendance_view_manage') && $type != 'user')
                                                                                            <strong data-toggle="modal" data-target="#exampleModalCenter" onclick="appendId({{strtotime($date)}}, {{$emp->id}},'P')">Make Present</strong>
                                                                                            @endif
                                                                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Leave Rate</h5>
                                <h2><span class="counter">{{round($leaveRate, 0)}}%</span> <span class="tuition-fees">{{round($leaveRate - $last_leaveRate,0)}}% <br> From Previous month</span></h2>
                            </div>
                        </div>
                    </div>
                </div>
